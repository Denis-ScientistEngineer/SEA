...
register_solver(IsothermalProcessSolver())
register_solver(AdiabaticProcessSolver())
...
register_solver(RankineCycleSolver())
register_solver(HeatEngineEfficiencySolver())
